...
@app.get("/stories/{st_id}")
def story(st_id: str =Path(None, description='The id of a short story, tepically the first word in the title')):
    try:
        return stories[st_id]
    except:
        return {'ERR': 'No story with given ID'}
